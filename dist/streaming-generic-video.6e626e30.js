...
},{"core-js/shim":"node_modules/core-js/shim.js","regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"node_modules/core-js/fn/regexp/escape.js"}],"WebRTC-Framework/js/streaming-generic-video.js":[function(require,module,exports) {
"use strict";
...
if (bandwidthLimit === null) {
  bandwidthLimit = 'unlimited'; // EDIT THIS VALUE TO TOGGLE INITIAL BANDWIDTH LIMIT
} // -------------------------------------------
...
var monitors = ['bytesReceived'];
var previousTime;
var prevBytesIntegral = 0; //local video component

var localVideo = document.querySelector("#gum-local");
var localStream; //streamed video component

var streamedVideo = document.querySelector("#gum-streamed");
var bandwidthButton = document.querySelector('input#bandwidth_button');
var bandwidthInput = document.querySelector('input#bandwidth_input');
var pc1;
var pc2;
...
function _onIceCandidate() {
  _onIceCandidate = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(pc, event) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return getOtherPc(pc).addIceCandidate(event.candidate);
...
function initiateVideoFeed() {
  return _initiateVideoFeed.apply(this, arguments);
}

function _initiateVideoFeed() {
  _initiateVideoFeed = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var stream;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            alert("getUserMedia() error: ".concat(_context2.t0.name));
...
function initiatePeerConnections() {
  ...
  pc1.addEventListener('icecandidate', function (e) {
    return onIceCandidate(pc1, e);
  });
  pc2 = new RTCPeerConnection(SDPSemantics);
  pc2.addEventListener('icecandidate', function (e) {
    return onIceCandidate(pc2, e);
  });
  var bitrateInterval = window.setInterval(getConnectionStats, 1000); //    let latencyInterval = window.setInterval(getLatency, 1000);
...
function connectPeerConnections() {
  return _connectPeerConnections.apply(this, arguments);
} // function getLatency() {
...
function _connectPeerConnections() {
  _connectPeerConnections = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var offer, answer;
...
function setMediaBitrate(sdp, media, bitrate) {
  ...
  console.debug("Found the m line for", media, "at line", line); // Pass the m line
...
function getConnectionStats() {
  pc2.getStats(null).then(function (stats) {
    var statsOutput = "";
    stats.forEach(function (report) {
      if (report.type === "inbound-rtp" && report.kind === "video") {
        Object.keys(report).forEach(function (statName) {
          if (monitors.includes(statName)) {
            var bytesIntegral = parseInt(report[statName]);
            var currentTime = new Date().getTime();
            var timeIntegral = (currentTime - previousTime) / 1000;
            var kbytesPerSecond = (bytesIntegral - prevBytesIntegral) / timeIntegral / 1000;
            prevBytesIntegral = bytesIntegral;
            previousTime = currentTime;
            statsOutput += "<strong>kilobit rate:</strong> ".concat((kbytesPerSecond * 8).toFixed(2), " kb/s <br>\n");
          }
        });
      }
    });
...
bandwidthButton.onclick = function () {
...
document.querySelector("#bitratelimit-box").innerHTML = "<strong>bitrate limit:</strong> ".concat(bandwidthLimit, " kb/s");
initiateVideoFeed().then(initiatePeerConnections).then(startTimer).then(connectPeerConnections);
},{"babel-polyfill":"node_modules/babel-polyfill/lib/index.js"}]},{},["WebRTC-Framework/js/streaming-generic-video.js"], null)
//# sourceMappingURL=/streaming-generic-video.6e626e30.js.map